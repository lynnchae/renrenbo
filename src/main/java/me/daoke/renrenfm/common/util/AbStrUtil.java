...
public final class AbStrUtil {
	 ...
	 * @return
	 */
	public static String getValidNum(int length){
	...
	public static synchronized String getCode() {
		...
		long codeNo = Long.parseLong((date));
		return codeNo+"";
	}

	public static String getCharAndNum(int length) {
		String val = "";
		synchronized(AbStrUtil.class){
			Random random = new Random();
			for (int i = 0; i < length; i++) {
				// 输出字母还是数字
    ...
    public static void main(String[] args) {
		long time1 = AbDateUtil.getConfirmDateTimeOfDay(new Date());
		long time2 = AbDateUtil.getConfirmDateTimeOfDay(AbDateUtil.getDateByFormat(AbDateUtil.getFirstDayOfMonth(AbDateUtil.dateFormatYMD),AbDateUtil.dateFormatYMD));
