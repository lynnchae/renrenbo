...
<head>
    ...
    <!--引入听众数据总统计js-->
    <script src="<%=basePath%>js/dataCount/listenerTotal.js"></script>
...
<div class="navbar navbar-default" id="navbar">
    ...
    <div class="main-container" id="main-container">
        ...
        <div class="col-xs-12">
            <h3 class="header smaller lighter green">FM听众数据总统计</h3>
            ...
            <div class="infobox infobox-green  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number" id="replyNum"></span>
                    <div class="infobox-content">回复总数</div>
                </div>
            </div>
            ...
            <div class="infobox infobox-pink  ">
                ...
                <div class="infobox-data">
                    <span class="infobox-data-number" id="rewardMoney"></span>
                    <div class="infobox-content">打赏总金额</div>
                </div>
            </div>
