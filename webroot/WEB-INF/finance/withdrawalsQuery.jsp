...
<head>
    ...
    <!--引入提现用户信息列表js-->
    <script src="<%=basePath%>js/finance/withdrawalsQuery.js"></script>
    ...
    <div class="main-container" id="main-container">
        ...
        <div id="dialog-message-status" class="hide">
            <div class="col-xs-12">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <p class="col-sm-3 text-left">账号：</p>
                        <div class="col-sm-9 text-left">
                            <span id="dialog_alipayAccount"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <p class="col-sm-3 text-left">账户类型：</p>
                        <div class="col-sm-9 text-left">
                            <span id="dialog_type"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <p class="col-sm-3 text-left">提现金额：</p>
                        <div class="col-sm-9 text-left">
                            <span id="dialog_cashNum"></span>&nbsp;&nbsp;元
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-xs-12">
            <form class="form-inline">
                ...
                <label>回执单号：</label>
                <input type="text" style="width: 150px;" id="receiptNumber"  name ="receiptNumber" class="input-small" placeholder="回执单号" />&nbsp;&nbsp;&nbsp;&nbsp;
                <label>账号：</label>
                <input type="text" style="width: 150px;" id="alipayAccount"  name ="alipayAccount" class="input-small" placeholder="账号" />&nbsp;&nbsp;&nbsp;&nbsp;
