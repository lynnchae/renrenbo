...
<head>
  ...
  <script src="<%=basePath%>assets/js/respond.min.js"></script>
    ...
    <!--引入充值列表界面的js-->
    <script src="<%=basePath%>js/statistics/rewardList.js"></script>
  ...
  <script type="text/javascript">
    ...
    <div class="col-xs-12">
      ...
      <form class="form-inline">
          <label>主播：</label> <input type="text" id="anchorName"  name ="anchorName" class="input-small" placeholder="主播昵称或真实姓名" style="width: 150px" />
          <label>听众昵称：</label> <input type="text" id="listenerName"  name ="listenerName" class="input-small" placeholder="听众昵称" style="width: 150px"/>
          <label>礼物名称：</label> <input type="text" id="presentName"  name ="presentName" class="input-small" placeholder="礼物名称" style="width: 150px"/>
