...
<head>
  ...
  <script src="<%=basePath%>assets/js/respond.min.js"></script>
    ...
    <!--引入充值列表界面的js-->
    <script src="<%=basePath%>js/statistics/sendGoldList.js"></script>
  ...
  <script type="text/javascript">
    ...
    <div class="col-xs-12">
      ...
      <form class="form-inline">
          <label>手机号码：</label> <input type="text" id="mobile"  name ="mobile" class="input-small" placeholder="mobile" />
          <label>状态：</label>
          <select class="select2-choices" name="isCollect" id="isCollect">
