...
<head>
  ...
  <script src="<%=basePath%>assets/js/respond.min.js"></script>
    ...
    <!--引入充值列表界面的js-->
    <script src="<%=basePath%>js/statistics/payBackRecord.js"></script>
  ...
  <script type="text/javascript">
    ...
    <div class="col-xs-12">
      ...
      <form class="form-inline">
          <label>订单号：</label> <input type="text" id="orderNo"  name ="orderNo" class="input-small" placeholder="订单编号" style="width: 150px" />
          <label>交易状态：</label>
          <select class="select2-choices" name="tradeStatus" id="tradeStatus">
